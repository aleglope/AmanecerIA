...
const LanguageSwitcher: React.FC = () => {
  ...
  return (
    <button
      ...
      className="p-2 w-10 h-10 flex flex-shrink-0 items-center justify-center rounded-full text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-300 font-semibold text-sm"
    >
      ...
      <div className="container mx-auto px-6 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-1 md:space-x-2">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 w-10 h-10 flex flex-shrink-0 items-center justify-center rounded-full text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-300"
            >
              {theme === "light" ? (
                <svg
            ...
            {user ? (
              <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center space-x-2">
                  <Avatar size="sm" />
                  <span className="text-gray-600 dark:text-gray-300 hidden sm:inline font-semibold">
                    {user.name}
                  </span>
                </div>
                <button
